 ...
 * DESCRIPTION
 * ---------------------------------------------------------------------------------------------------------------------
 * This file contains the example of using link() with Filesystem.
 *
 * ---------------------------------------------------------------------------------------------------------------------
 * USAGE
 * ---------------------------------------------------------------------------------------------------------------------
 ...
 *
 * Ex:
 * $> php ./example/node_link.php --driver=standard --invoker=standard
 *
 * ---------------------------------------------------------------------------------------------------------------------
 */
...
$process = function() use($loop, $fsm) {
    ...
    Promise::doResolve()
        ->then(function() use($fsm, $srcPath, $dstPath) {
            return $fsm->link($srcPath, $dstPath);
        })
